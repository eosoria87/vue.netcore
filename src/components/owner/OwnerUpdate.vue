    ...
    <div class="form-wrapper">
      <b-form @submit.prevent="updateOwner">
        ...
        <b-col :md="5" offset="4">
          ...
          <b-button :to="{ name: 'OwnerList' }" variant="danger"
            >Cancel</b-button
          >
        </b-col>
      </b-form>
...
export default {
  ...
  methods: {
    updateOwner() {
      ...
      OwnerService.update(this.$router.currentRoute.params.id, this.formData)
        .then(() => {
          this.isSuccessfully = true;
          this.alertModalTitle = "Exitosamente";
          this.alertModalContent = "Propietario de la cuenta actualizado correctamente";
